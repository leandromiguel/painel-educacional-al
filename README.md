...
alagoanos. Desenvolvido como projeto final do curso de Data Analytics /
Data Visualization.
...
Os arquivos de EF Anos Finais e Ensino Médio foram baixados mas não
são utilizados nas análises. Uma extensão natural do projeto seria
comparar o desempenho dos municípios ao longo das três etapas.
